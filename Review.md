...
---
1.거래서비스 테스트 코드  
2.거래시 포인트결제를 위한 포인트 엔티티 및 서비스 구현  
3.포인트 출금 구현  
4.포인트 증가/차감 내역 조회 기능 구현  

10/7 ->
---
1. viewController 분리
2. 거래시 포인트 결제를 위해 아임포트 API연동
3. 금액지불 기록 영속화 
...
10/10 ->
---
1. 조회기능에  readOnly transaction 적용
2. 거래 서비스 테스트 코드에 포인트 서비스 적용 
3. 거래 서비스 거래 완료 로직 구현 