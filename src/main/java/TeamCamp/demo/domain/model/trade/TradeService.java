...
public class TradeService {
    ...
    public TradeDto.TradeResource makeTradeResource(User user, Product product){
        return makeTradeResource(user,product);
    }

    public void purchase(String email , TradeDto.TradeRequest request){

    }
    public void sale(String email, TradeDto.TradeRequest request){
