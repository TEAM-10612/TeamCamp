...
include::{snippets}/users/withdrawal/successful/request-fields.adoc[]

**Example request**
include::{snippets}/users/withdrawal/successful/http-request.adoc[]

**Example response**
include::{snippets}/users/withdrawal/successful/http-response.adoc[]

`*_2. Fail_*`

include::{snippets}/users/withdrawal/failure/request-fields.adoc[]

**Example request**
include::{snippets}/users/withdrawal/failure/http-request.adoc[]

**Example response**
include::{snippets}/users/withdrawal/failure/http-response.adoc[]
...
`*_3.인증 후 비밀번호 변경_성공_*`
**request-fields**
include::{snippets}/users/forgetPassword/updatePassword/request-fields.adoc[]

**Example request**
include::{snippets}/users/forgetPassword/updatePassword/http-request.adoc[]

**Example response**
include::{snippets}/users/forgetPassword/updatePassword/http-response.adoc[]
...
include::{snippets}/trade/sell//curl-request.adoc[]

**request-fields**

include::{snippets}/trade/sell/request-fields.adoc[]

**example request**

include::{snippets}/trade/sell/http-request.adoc[]

**example response**

include::{snippets}/trade/sell/http-response.adoc[]
...
include::{snippets}/trade/buy/curl-request.adoc[]

**request-fields**

include::{snippets}/trade/buy/request-fields.adoc[]

**example request**

include::{snippets}/trade/buy/http-request.adoc[]

**example response**

include::{snippets}/trade/buy/http-response.adoc[]
